...
export default function S1112(){
  const classes = useStyles();
    return(
    <Grid container xs={12} className={classes.container} >

      <Grid item xs={12} style={{display: 'flex', justifyContent: 'center'}}>
         <h1> Instrumented Drawbar S1112 </h1>
      </Grid>
      ...
      <Grid item xs={12} style = {{display: 'flex', justifyContent: 'left', marginLeft: '400px'}}>
        <h2> 
          Purpose : Measure in-train forces <br/><br/>
          IRT ID : S1112 <br/><br/>
          Vehicle ID: mtr07 <br/><br/>
          Installation Date : 2018-03-14 <br/><br/>
          Callibration Date : 2019-06-18 <br/><br/>
