...
export default function S1122(){
  const classes = useStyles();
    return(
    <Grid container xs={12} className={classes.container} >

      <Grid item xs={12} style={{display: 'flex', justifyContent: 'center'}}>
         <h1> Instrumented Suspension Spring S1122 </h1>
      </Grid>
      ...
      <Grid item xs={12} style={{display: 'flex', justifyContent: 'center'}}>
        <h2> 
          ...
          IRT ID : S1122 <br/><br/>
          Vehicle ID: mtr14 <br/><br/>
          Installation Date : 2018-03-22 <br/><br/>
          Callibration Date : 2019-05-26 <br/><br/>
