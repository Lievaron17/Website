...
export default function S1126(){
  const classes = useStyles();
    return(
    <Grid container xs={12} className={classes.container} >

      <Grid item xs={12} style={{display: 'flex', justifyContent: 'center'}}>
         <h1> Instrumented Suspension Spring S1126 </h1>
      </Grid>
      ...
      <Grid item xs={12} style={{display: 'flex', justifyContent: 'center'}}>
        <h2> 
          ...
          IRT ID : S1126 <br/><br/>
          Vehicle ID: mtr18 <br/><br/>
          Installation Date : 2018-07-19 <br/><br/>
          Callibration Date : 2019-09-13 <br/><br/>
          Status Check : bad <br/>
        </h2>
      </Grid>
