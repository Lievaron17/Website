...
export default function S1124(){
  const classes = useStyles();
    return(
    <Grid container xs={12} className={classes.container} >

      <Grid item xs={12} style={{display: 'flex', justifyContent: 'center'}}>
         <h1> Instrumented Suspension Spring S1124 </h1>
      </Grid>
      ...
      <Grid item xs={12} style={{display: 'flex', justifyContent: 'center'}}>
        <h2> 
          ...
          IRT ID : S1124 <br/><br/>
          Vehicle ID: mtr16 <br/><br/>
          Installation Date : 2018-02-04 <br/><br/>
          Callibration Date : 2019-07-09 <br/><br/>
